...
```env
# Site Configuration
NEXT_PUBLIC_SITE_URL=https://luckylink.click
...
SMTP_PORT=465
SMTP_USER=you@luckylink.click
SMTP_PASS=your_app_password
SMTP_FROM="Lucky Link LLC <noreply@luckylink.click>"
CONTACT_EMAIL=you@luckylink.click
```
